    ...
    return (
        <Card>
            ...
            <Flex direction="column" gap="4">
                <Heading size="6" color={color}>{t('sudoku.title')}</Heading>

                <Text>{t('sudoku.intro1')}</Text>
                <Text>{t('sudoku.intro2')}</Text>
                <Heading size="4" color={color}>{t('sudoku.h_plan')}</Heading>
                ...
                <Heading size="4" color={color}>{t('sudoku.h_rowCheck')}</Heading>
                ...
                />
                <Heading size="4" color={color}>{t('sudoku.h_twoVersions')}</Heading>
                ...
                <Heading size="4" color={color}>{t('sudoku.h_implementation')}</Heading>
                ...
                <Heading size="4" color={color}>{t('sudoku.h_architecture')}</Heading>
                ...
                <Heading size="4" color={color}>{t('sudoku.h_colExtractor')}</Heading>
                ...
                />
                <Heading size="4" color={color}>{t('sudoku.h_subsquares')}</Heading>
                ...
                />
                <Heading size="4" color={color}>{t('sudoku.h_subsquaresTests')}</Heading>
                ...
                />
                <Heading size="4" color={color}>{t('sudoku.h_debugging')}</Heading>
                ...
                />
                <Heading size="4" color={color}>{t('sudoku.h_summary')}</Heading>
