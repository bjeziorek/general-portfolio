...
export function PATTyping() {
    ...
    return (
        <>
            <Heading size="6" color={color}>{t('pat.h_types')}</Heading>
            <Text>{t('pat.types1')}</Text>
            <Text>{t('pat.types2')}</Text>
            <Text>{t('pat.types3')}</Text>
            <Heading size="4" color={color}>{t('pat.h2_types1')}</Heading>
            <Card my='4'>
            ...
            <Heading size="4" color={color}>{t('pat.h2_types2')}</Heading>
            <Card my='4'>
            ...
            <Heading size="4" color={color}>{t('pat.h2_types3')}</Heading>
            <Card my='4'>
