...
export function PATSubcomponentCut() {
    ...
    return (
        <Flex direction="column">
            <Heading size="6" color={color}>{t("pat.h_components")}</Heading>
            ...
            <Heading size="4" color={color}>{t("pat.h2_components1")}</Heading>
            ...
            <Heading size="4" color={color}>{t("pat.h2_components2")}</Heading>
