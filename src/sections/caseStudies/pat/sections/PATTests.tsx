...
export function PATTests() {
  ...
  return (
    <>
      <Heading size="6" color={color}>{t('pat.h_tests')}</Heading>
      <Text>{t('pat.tests1')}</Text>
      <Text>{t('pat.tests2')}</Text>

      <Heading size="4" color={color}>{t('pat.h2_tests1')}</Heading>
...
describe('toggleSortState', () => {
  ...
  it('does not mutate previous state', () => {
    ...
    expect(result).not.toBe(prev);
        ...
        `} />
      <Heading size="4" color={color}>{t('pat.h2_tests3')}</Heading>
      ...
      <Heading size="4" color={color}>{t('pat.h2_tests4')}</Heading>
...
`} />
      ...
      <Heading size="4" color={color}>{t('pat.h2_tests5')}</Heading>
...
`}
      ...
      />
      <Heading size="4" color={color}>{t('pat.h2_tests2')}</Heading>
