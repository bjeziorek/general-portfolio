...
export function PATLib() {
    ...
    return (
        <Flex direction='column'>
            <Heading size="6" color={color}>{t('pat.h_lib')}</Heading>
            <Text>{t('pat.lib2')}</Text>
            <Text>{t('pat.lib3')}</Text>
            <Heading size="4" color={color}>{t('pat.h2_lib1')}</Heading>
            ...
            <Heading size="4" color={color}>{t('pat.h2_lib4')}</Heading>
            ...
            <Heading size="4" color={color}>{t('pat.h2_lib2')}</Heading>
