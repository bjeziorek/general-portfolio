...
function FAQ() {
    ...
    return (
        <>
            <Heading size='6' color={color}>{t("faq.title")}</Heading>
            <Flex direction="column" gap="4">
                <Flex direction="column">
                    <Heading size="4" color={color}>{t('faq.q1')}</Heading>
                ...
                <Flex direction="column">
                    <Heading size="4" color={color}>{t('faq.q2')}</Heading>
                ...
                <Flex direction="column">
                    <Heading size="4" color={color}>{t('faq.q3')}</Heading>
                ...
                <Flex direction="column">
                    <Heading size="4" color={color}>{t('faq.q4')}</Heading>
