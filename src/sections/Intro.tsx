...
export function Intro() {
    ...
    return (
        <Flex direction="column" gap="4" m="4">
            <Heading color={color} size="6">{t("intro.aboutMe")}</Heading>
            <Card>
                <Box m='4'>
                    <Flex direction="column" gap="4">
                         <Heading size="4"  color={color} my="0">{t("intro.me")}</Heading>
                        <Text>{t("intro.new2_1")}</Text>
                        <Text>{t("intro.new2_2")}</Text>
                        <Text>{t("intro.new2_3")}</Text>
                        <Text>{t("intro.new2_4")}</Text>
                    </Flex>
                </Box>
            </Card>
            <Card>
                <Box m='4'>
                    <Flex direction="column" gap="4">
                         <Heading size="4" color={color} my="0">{t("intro.drive")}</Heading>
            ...
            <Grid columns={{ initial: "1", md: "2" }} gap="3" width="auto">
                <Card>
                    <Flex direction="column" gap="4" mx="4" justify="between" height="100%">
                        <Heading size="4" color={color} mb="0" mt="2">{t("intro.architecture")}</Heading>
                ...
                <Card>
                    <Flex direction="column" gap="4"  mx="4" justify="between"  height="100%">
                        <Heading size="4" color={color} mb="0" mt="2">{t("intro.video")}</Heading>
                ...
                <Card>
                    <Flex direction="column" gap="4"  mx="4" justify="between"  height="100%">
                        <Heading size="4"  color={color} mb="0" mt="2">{t("intro.more")}</Heading>
                ...
                <Card>
                    ...
                    <Flex direction="column" gap="4"  mx="4" justify="between"  height="100%"> 
                         <Heading size="4"  color={color} mb="0" mt="2">{t("intro.qnd")}</Heading>
                ...
                <Card>
                    ...
                    <Flex direction="column" gap="4"  mx="4" justify="between"  height="100%">
                        <Heading size="4"  color={color} mb="0" mt="2">{t("intro.brain")}</Heading>
